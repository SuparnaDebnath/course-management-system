                    ...
                    <form action="" method="post">
                        <table >
                            <tr>
                                ...
                                <td><input style="height: 30px; width: 100px;" type="text" name="name" value="input Name"></td>
                                ...
                                <td><a style="text-decoration: none;" href="update_teacher.php"><input class="button" style="margin-left: 50px; height: 30px; width: 100px;" type="button" name="update" value="UPDATE"></a></td>
                            </tr>
